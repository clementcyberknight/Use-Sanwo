      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-medium text-gray-900 mb-6">
            ...
            <br />
            <span className="text-black">Business Operations</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                At Sanwó, we believe that running a business shouldn't be
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <Briefcase className="w-8 h-8 text-black mb-4" />
                <h3 className="text-xl font-medium text-gray-900 mb-2">
                  Security
                </h3>
